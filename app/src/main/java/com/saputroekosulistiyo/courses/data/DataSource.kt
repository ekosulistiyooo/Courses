package com.saputroekosulistiyo.courses.data


import com.saputroekosulistiyo.courses.R
import com.saputroekosulistiyo.courses.model.Topic

object DataSource { // Objek singleton yang menyimpan data sumber topik
    val topics = listOf( // Daftar yang berisi objek Topic
        // Membuat daftar topik yang berisi informasi tentang setiap topik
